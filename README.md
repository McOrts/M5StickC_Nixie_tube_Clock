...
Previously, it is mandatory install the development environment. If you use the Arduino IDE, exists a perfect guide to start up the device : [Arduino IDE environment - M5StickC](https://docs.m5stack.com/en/quick_start/m5stickc/arduino) 
